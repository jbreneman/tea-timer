					...
					state.interval = window.setInterval(function () {
						if (active.countdown > 0) {
							...
							if (state.permissions.sound) {
								...
								(0, _util.playChord)([config.notes['E4'], config.notes['G#4'], config.notes['B4']], 500).then(function () {
									return (0, _util.playChord)([config.notes['D4'], config.notes['F#4'], config.notes['A4']], 500);
								}).then(function () {
									return (0, _util.playChord)([config.notes['F#4'], config.notes['A4'], config.notes['C#4']], 500);
								});
							}
						}
					}, 16);
