...
var vm = new _vue2.default({
	...
	ready: function ready() {
		this.on('timer:update', function (val) {
			var timers = this.timers.splice(0);
...
var store = new _vuex2.default.Store({
	...
	mutations: {
		...
		setTimer: function setTimer(state, mutation) {
			state.timers = state.timers.forEach(function (timer, index) {
...
_vue2.default.component('timer-item', {
    ...
    components: {
        'amount': {
            ...
            watch: {
                inputMinutes: function inputMinutes(val) {
                    var amount = parseInt(this.inputMinutes) * 60 + parseInt(this.inputSeconds);
                    this.$emit('timer:update', { id: this.timer.id, amount: +amount, desc: this.timer.desc });
                },
                inputSeconds: function inputSeconds(val) {
                    var amount = parseInt(this.inputMinutes) * 60 + parseInt(this.inputSeconds);
                    this.$emit('timer:update', { id: this.timer.id, amount: +amount, desc: this.timer.desc });
                }
            }
