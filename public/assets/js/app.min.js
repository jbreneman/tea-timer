...

{
	var vm = new _vue2.default({
		...
		replace: false,
		events: {
			'nav:update': function navUpdate(val) {
				this.activeNav = val;
			},
			'timer:update': function timerUpdate(val) {
				//update amount in store
			}
		}
	});
}
},{"./libs/vue":2,"./modules/templates":3}],2:[function(require,module,exports){
(function (global){
/*!
 * Vue.js v1.0.26
 * (c) 2016 Evan You
...
},{"../libs/vue":2,"./util":4}],4:[function(require,module,exports){
module.exports = {
