					...
					state.interval = window.setInterval(function () {
						if (active.countdown > 0) {
							...
							if (state.permissions.sound) {
								...
								(0, _util.playChord)([notes['E4'], notes['G#4'], notes['B4']], 500).then(function () {
									return (0, _util.playChord)([notes['D4'], notes['F#4'], notes['A4']], 500);
								}).then(function () {
									return (0, _util.playChord)([notes['F#4'], notes['A4'], notes['C#4']], 500);
								});
							}
						}
					}, 16);
...
exports.splitTime = exports.formatTime = undefined;
