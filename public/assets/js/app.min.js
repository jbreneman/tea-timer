...
},{"./config":22,"./modules/filters":23,"./modules/storage":24,"./modules/store":25,"./modules/templates":26,"vue":19,"vue-touch":18}],22:[function(require,module,exports){
"use strict";
...
},{"vue":19}],24:[function(require,module,exports){
'use strict';
...
},{"lodash/isString":12}],25:[function(require,module,exports){
'use strict';
					...
					state.interval = window.setInterval(function () {
						if (active.countdown > 0) {
							...
							if (state.permissions.sound) {
								...
								(0, _util.playChord)([config.notes['E4'], config.notes['G#4'], config.notes['B4']], 750).then(function () {
									return (0, _util.playChord)([config.notes['D4'], config.notes['F#4'], config.notes['A4']], 750);
								}).then(function () {
									return (0, _util.playChord)([config.notes['F#4'], config.notes['A4'], config.notes['C#4']], 750);
								});
							}
						}
					}, 16);
...
},{"../config":22,"./storage":24,"./util":27,"vue":19,"vuex":20}],26:[function(require,module,exports){
'use strict';
...
_vue2.default.component('reset-button', {
    props: ['timer'],
    methods: {
        resetTimer: function resetTimer(n) {
...
_vue2.default.component('play-button', {
    props: ['timer'],
    computed: {
...
_vue2.default.component('options', {
    computed: {
        active: function active() {
...
_vue2.default.component('options-nav', {
...
_vue2.default.component('options-section', {
    props: ['timers'],
    template: '\n    \t<section class="timer-opts__section">\n    \t\t<slot></slot>\n    \t</section>\n    '
});

_vue2.default.component('new-timer', {
    computed: {
...
_vue2.default.component('timer-item', {
    props: ['timer'],
    data: function data() {
        return {
            swiped: 0,
...
_vue2.default.component('preferences', {
    computed: {
...
_vue2.default.component('toggle', {
...
},{"./util":27,"lodash/throttle":15,"vue":19}],27:[function(require,module,exports){
'use strict';
...
var createChord = function createChord(context, frequencies) {
...
var playChord = exports.playChord = function playChord(chord) {
	var speed = arguments.length <= 1 || arguments[1] === undefined ? 500 : arguments[1];

	return new Promise(function (resolve, reject) {
		var context = new AudioContext();

		createChord(context, chord).forEach(function (note, index) {
