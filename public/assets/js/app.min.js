...
},{"./isObject":10,"./now":14,"./toNumber":16}],9:[function(require,module,exports){
/**
...
},{"./_baseGetTag":3,"./isArray":9,"./isObjectLike":11}],13:[function(require,module,exports){
var baseGetTag = require('./_baseGetTag'),
    isObjectLike = require('./isObjectLike');
...
},{"./_baseGetTag":3,"./isObjectLike":11}],14:[function(require,module,exports){
var root = require('./_root');
...
},{"./_root":7}],15:[function(require,module,exports){
...
},{"./debounce":8,"./isObject":10}],16:[function(require,module,exports){
var isObject = require('./isObject'),
...
},{"./isObject":10,"./isSymbol":13}],17:[function(require,module,exports){
...
},{"hammerjs":1}],19:[function(require,module,exports){
...
var _sounds = require('./util/sounds');
	...
	if (Notification.permission !== 'granted' && Notification.permission !== 'denied') {
		Notification.requestPermission(function (permission) {
			if (permission === 'granted') {
				_store.store.commit('updatePermissions', { notifications: true });
			} else {
				_store.store.commit('updatePermissions', { notifications: false });
			}
		});
	}
}
...
var vm = new _vue2.default({
	...
	mounted: function mounted() {
		storage.set('version', config.version);
		_store.store.commit('updateSizes', { width: this.$el.querySelector('.timer__body').offsetWidth, height: this.$el.querySelector('.timer__body').offsetHeight });
		this.$el.style.height = this.$el.offsetHeight + 'px';
		this.$el.style.width = this.$el.offsetWidth + 'px';

		// Initialize theme colors
		(0, _util.updateTheme)(_store.store.state.themes.filter(function (theme) {
			return theme.active;
		})[0]);
		...
		(0, _sounds.initializeSounds)([_store.store.state.sound.piano]);
	}
});

},{"./components/app":22,"./config":34,"./modules/filters":35,"./modules/storage":36,"./modules/store":37,"./util":38,"./util/sounds":39,"vue":19,"vue-touch":18}],22:[function(require,module,exports){
'use strict';
...
var _timerTitle = require('./timer-title');
...
var App = exports.App = {
	components: { timerTitle: _timerTitle.timerTitle, countdown: _countdown.countdown, options: _options.options },
	template: '\n\t\t<div id="app" class="timer">\n\t\t\t<timer-title></timer-title>\n\t\t\t<section class="timer__body">\n\t\t\t\t<countdown></countdown>\n\t\t\t\t<options></options>\n\t\t\t</section>\n\t\t</div>\n\t'
}; // Components

},{"./countdown":23,"./options":27,"./timer-title":32}],23:[function(require,module,exports){
'use strict';
...
// Components
var countdown = exports.countdown = {
    computed: {
        active: function active() {
            return this.activeTimer && this.activeTimer.playing && this.$store.state.interval;
        },
        activeTimer: function activeTimer() {
            return this.$store.state.timers.filter(function (timer) {
                return timer.active;
            })[0] || false;
        },
        ...
        formattedTotal: function formattedTotal() {
            var formatted = util.formatTime(this.activeTimer.amount);
            return formatted.minutes + ':' + formatted.seconds;
        },
        formattedCountdown: function formattedCountdown() {
            var formatted = util.splitTime(this.activeTimer.countdown);
    ...
    components: { resetButton: _resetButton.resetButton, playButton: _playButton.playButton },
...
},{"../util":38,"./play-button":28,"./reset-button":30}],24:[function(require,module,exports){
"use strict";
...
var newTimer = exports.newTimer = {
    computed: {
        newTimer: function newTimer() {
            var id = 0;

            if (this.$store.state.timers) {
                id = Math.max.apply(Math, _toConsumableArray(this.$store.state.timers.map(function (timer) {
                    return timer.id;
                }))) + 1;
            }
    ...
    methods: {
        addNewTimer: function addNewTimer(timer) {
...
var optionsNav = exports.optionsNav = {
    props: {
        navOptions: {
            type: Array,
            required: true
...
var optionsSection = exports.optionsSection = {
...
var _optionsNav = require('./options-nav');

var _optionsSection = require('./options-section');

var _timerItem = require('./timer-item');

var _newTimer = require('./new-timer');
...
var options = exports.options = {
    ...
    components: { optionsNav: _optionsNav.optionsNav, optionsSection: _optionsSection.optionsSection, timerItem: _timerItem.timerItem, newTimer: _newTimer.newTimer, preferences: _preferences.preferences },
...
},{"./new-timer":24,"./options-nav":25,"./options-section":26,"./preferences":29,"./timer-item":31}],28:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
var playButton = exports.playButton = {
    props: {
        timer: {
            type: Object,
            required: true,
...
var preferences = exports.preferences = {
    data: function data() {
        return {
            currentTheme: this.$store.state.themes.filter(function (theme) {
                return theme.active;
            })[0].name
        };
    },
    ...
    components: { toggle: _toggle.toggle },
...
},{"./toggle":33,"vuex":20}],30:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
var resetButton = exports.resetButton = {
    props: {
        timer: {
            type: Object,
            required: true,
...
var timerItem = exports.timerItem = {
    props: ['timer'],
    data: function data() {
        return {
            swiped: 0,
    ...
    methods: {
        pan: function pan($event) {
            if ($event.angle > 135 || $event.angle < -135) {
                var num = Math.abs(Math.round($event.distance / 2));
                this.swiped = num < 100 ? num : 100;
            }
        },
        panend: function panend($event) {
            var velocity = Math.abs(Math.round($event.velocity));
        ...
        'edit-time': {
            ...
            methods: {
                saveTime: function saveTime() {
                    var amount = this.minutes * 60 + this.seconds;
                    this.$store.commit('setTimer', { id: this.timer.id, amount: amount, countdown: amount, editing: false });
                },

                onPan: (0, _throttle2.default)(function (mutation, $event) {
...
},{"../util":38,"lodash/throttle":15}],32:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
	value: true
});
var timerTitle = exports.timerTitle = {
...
_vue2.default.filter('leadingZero', function (value) {
	return value < 10 ? '0' + value : value;
});

},{"vue":19}],36:[function(require,module,exports){
'use strict';
...
function get(key) {
	var isObject = arguments.length <= 1 || arguments[1] === undefined ? true : arguments[1];

	if ((0, _isString2.default)(key) && key !== '') {
...
function set(key, val) {
	var isObject = arguments.length <= 2 || arguments[2] === undefined ? true : arguments[2];

	if ((0, _isString2.default)(key) && key !== '' && val) {
		var str = isObject ? JSON.stringify(val) : val;
...
},{"lodash/isString":12}],37:[function(require,module,exports){
'use strict';
...
var notifications = 'Notification' in window && Notification.permission === 'granted';
...
var store = new _vuex2.default.Store({
	...
	mutations: {
		updateSizes: function updateSizes(state, mutation) {
			state.settings.width = mutation.width;
			state.settings.height = mutation.height;
		},
		navUpdate: function navUpdate(state, mutation) {
			state.activeNav = mutation;
		},
		setTimer: function setTimer(state, mutation) {
			var playing = state.timers.filter(function (timer) {
				return timer.id === mutation.id;
			})[0];
			...
			if (state.timers && state.timers.filter(function (timer) {
				return timer.id === mutation.id;
			}).length > 0) {
				state.timers.forEach(function (timer, index) {
		...
		removeTimer: function removeTimer(state, mutation) {
			var index = state.timers.map(function (timer) {
				return timer.id;
			}).indexOf(mutation.id);
		...
		toggleTimer: function toggleTimer(state, mutation) {
			var playing = state.timers.filter(function (timer) {
				return timer.id === mutation.id;
			})[0];
			...
			if (playing && playing.playing && state.interval) {
				...
				(function () {
					...
					var active = state.timers.filter(function (timer) {
						return timer.active;
					})[0];
		...
		updatePermissions: function updatePermissions(state, mutation) {
			Object.keys(mutation).forEach(function (key) {
				state.permissions[key] = mutation[key];
			});
			storage.set('permissions', state.permissions);
		},
		togglePermission: function togglePermission(state, mutation) {
		...
		updateTheme: function updateTheme(state, mutation) {
			state.themes = state.themes.map(function (theme) {
				theme.active = theme.name === mutation.theme;
				return theme;
			});

			(0, _util.updateTheme)(state.themes.filter(function (theme) {
				return theme.active;
			})[0]);
...
},{"../config":34,"../util":38,"./storage":36,"vue":19,"vuex":20}],38:[function(require,module,exports){
'use strict';
...
var formatTime = exports.formatTime = function formatTime(seconds) {
	var leadingZeroMinute = arguments.length <= 1 || arguments[1] === undefined ? false : arguments[1];
...
function wrapCharacters(str) {
	var className = arguments.length <= 1 || arguments[1] === undefined ? null : arguments[1];
...
var splitTime = exports.splitTime = function splitTime(seconds) {
	var time = formatTime(seconds, true);
...
var updateTheme = exports.updateTheme = function updateTheme(theme) {
...
var mediaPlaybackRequiresUserGesture = function mediaPlaybackRequiresUserGesture() {
...
var removeBehaviorsRestrictions = function removeBehaviorsRestrictions() {
...
var initializeSounds = exports.initializeSounds = function initializeSounds(soundArray) {
