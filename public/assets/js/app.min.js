        ...
        'amount': {
            ...
            methods: {
                inputMinutes: function inputMinutes() {
                    var amount = parseInt(this.$el.querySelector('.timer-item__minutes').value) * 60 + parseInt(this.seconds);
                ...
                inputSeconds: function inputSeconds() {
                    var amount = parseInt(this.minutes) * 60 + parseInt(this.$el.querySelector('.timer-item__seconds').value);
                    this.$store.commit('setTimer', { id: this.timer.id, amount: +amount, countdown: +amount, desc: this.timer.desc });
                }
            }
        },
